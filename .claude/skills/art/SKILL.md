...
**Key:** Mermaid structure (flowchart/sequence/state/class/ER) + Excalidraw sketchy hand-drawn aesthetic + UL colors
...
- User says 'art', 'UL illustration', 'editorial image', 'blog header'
